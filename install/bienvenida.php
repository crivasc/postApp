...
<body>
    <div class="card shadow-sm">
        <div class="card-body text-center">
            ...
            <h1><?=SITE_NAME?> </h1>
            <p class="card-text">se ha instalado correctamente</p>
            ...
            <div>
                <a href="<?=BASE_URL.'?page=login'?>" target="_blank" class="my-2 btn btn-sm btn-success shadow-sm">Login</a><br>
                <a href="./sources/demoCont.php" class="my-2 btn btn-sm btn-success shadow-sm">Instalar posts demo?</a>
            </div>    
        </div>
    </div>
</body>
